...
<%
    ...
    String MUSIC_NAME = (String) application.getAttribute("name");
//    out.println(MUSIC_NAME);
//    String MUSIC_NAME = request.getParameter("name");
    //String SE_SQL = "select * from music where title like'%" + MUSIC_NAME + "%'";
    rs = conn.executeQuery("select * from music where title like'%" + MUSIC_NAME + "%'"+"or singer like'%"+ MUSIC_NAME + "%'"+"order by id DESC");
    if (rs.next()) {
        do {
