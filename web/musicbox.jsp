										...
										int maxSong = limit + pagesize;
													...
													out.println("<div class=\"yahoo2\">"
															+ function.page(maxPage, nowpage, pagesize,
																	"musicbox.jsp", noAjax)
															+ "</div><br />");
													//out.println("<div align=center> <label>选中项：<select name=select id=select class=width_100> <option value=play>播放</option><option value=del>删除</option> </select> </label> <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type=\"submit\"  value=提交> </label>  </div></FORM>");
													out.println("");
												} else {
